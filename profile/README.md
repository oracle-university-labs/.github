...
Our repositories enable learners to explore Oracle Cloud Infrastructure (OCI) concepts through guided activity guides, hands-on labs, and demo-ready code samples. You can use these resources with:

- Oracle University paid lab subscriptions (sandbox environments)  
- Your existing Oracle Cloud account  
- An Oracle Cloud Free Tier account  

These examples will help you practice, build, test, and deploy applications on Oracle Cloud as part of your learning journey.
